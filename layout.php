...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/custom-bootstrap-styles.css"/>
    <link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css" />
    <!-- Fontst -->
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Exo:ital,wght@0,100..900;1,100..900&family=Nunito+Sans:ital,opsz,wght@0,6..12,200..1000;1,6..12,200..1000&display=swap" rel="stylesheet">
    <!-- SwiperJS -->
...
<body>
    ...
    <script>
        ...
        function showMessage(message, success){
            ...
            const alertIcon = success ? '<i class="uil uil-check-circle"></i>' : '<i class="bi bi-exclamation-triangle"></i>';
